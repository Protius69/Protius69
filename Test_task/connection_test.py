...
secrets = {"jira_login": "Твой логин без @ozon.ru",
           "jira_password": "Твой доменный пароль"}

# -------------------------------------------------------------------

jira_options = {'server': 'https://jira.o3.ru/'}
jira = JIRA(options=jira_options, basic_auth=(secrets['jira_login'], secrets['jira_password']))
